@extends('layouts.app')
@section('content')
<div class="login-box" style="background-image: url(https://images.unsplash.com/photo-1560279328-1ee389f21bc6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80);">
